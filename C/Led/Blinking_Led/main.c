...
#if INTERRUPT
	timer1_Strut.mode				= COMPARE;
	timer1_Strut.prescalar		    = F_CPU_256;
	timer1_Strut.s_init			    = 0;
	timer1_Strut.s_compare			= 2000;
	timer1_Strut.interrupt			= TRUE;

#else
	timer1_Strut.mode				= COMPARE;
	timer1_Strut.prescalar		    = F_CPU_1024;
	timer1_Strut.s_init			    = 0;
	timer1_Strut.s_compare			= 100;
